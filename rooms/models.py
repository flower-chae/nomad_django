...
class Room(CommonModel):
    ...
    class RoomKindChoices(models.TextChoices): #gpt
    ...
    amenities = models.ManyToManyField("rooms.Amenity", related_name="rooms") #gpt 
    ...
    def rating(reverse):
        count = reverse.reviews.count()
        if count == 0 :
            return "No Reviews"
        else:
            total_rating = 0
            for review in reverse.reviews.all().values("rating"):
